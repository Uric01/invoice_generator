...
$pdf->cell(99, 5, ': 2022-07-04', 0, 0);
$pdf->cell(39, 5, 'Tax Invoice', 0, 0);
$pdf->cell(39, 5, ': #20220704AZ1', 0, 1);
$pdf->SetFont('Arial', '', 35);
$pdf->cell(120, 20, '', 0, 0);
$pdf->cell(39, 20, 'R57 500', 0, 1);
$pdf->Ln(10);
$pdf->SetFont('Arial', '', 12);
...
$pdf->cell(22, 5, '5', 0, 0);
$pdf->cell(34, 5, 'NX.HQHG5.001', 0, 0);
$pdf->cell(60, 5, 'Acer Nitro 5 i7 8GB', 0, 0);
$pdf->cell(40, 5, 'R10 000', 0, 0);
$pdf->cell(26, 5, 'R50 000', 0, 1);
$pdf->Line(12, 200, 197, 200);
$pdf->Ln(80);
$pdf->cell(120, 10, '', 0, 0);
$pdf->cell(40, 10, 'VAT', 0, 0);
$pdf->cell(26, 10, 'R7 500', 0, 1);
$pdf->cell(120, 10, '', 0, 0);
$pdf->cell(40, 10, 'TOTAL', 0, 0);
$pdf->cell(26, 10, 'R57 500', 0, 1);
